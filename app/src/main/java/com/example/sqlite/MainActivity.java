...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter1 = new  ArrayAdapter<>(this, android.R.layout.simple_list_item_1,UbicacionS);
        Ubicacion.setAdapter(adapter1);
    ...
    public void EliminarProducto(View view){
        ...
        String IDProducto = ID.getText().toString();
        if (!IDProducto.isEmpty()){
            int Eliminar = BaseDatos.delete("Inventario_Bodega", "ID_Producto=" +IDProducto, null);
            if (Eliminar == 1){
                ID.setText("");
                Nombre.setText("");
                Categoria.setSelection(0);
                ...
                Precio.setText("");
                Ubicacion.setSelection(0);
                Toast.makeText(this, "El producto se elimino correctamente", Toast.LENGTH_SHORT).show();
                BaseDatos.close();
            } else {
